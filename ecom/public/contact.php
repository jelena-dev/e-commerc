...
<?php include(TEMPLATE_FRONTEND .  "/top_nav.php");?>
                    ...
                    <form name="sentMessage" id="contactForm" >
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="subject" class="form-control" placeholder="Subject *" id="subject" required data-validation-required-message="Please enter subject.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
